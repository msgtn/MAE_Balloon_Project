...
mo='01';        % month, initially
da='01';        % day, initially
hr='00';        % time, initially
...
m3=10;                      % kg, mass of the x only mass
m4=10;                      % kg, mass of the y only mass
...
% Simulation
numbs=100;                   % number of iterations
...
for i=1:numbs
    ...
    conds=[xb,yb,zb,xbd,ybd,zbd,x3,y4,...
    x3d,y4d,wx,wy,wz,dt,xcmb,ycmb,xcmbd,ycmbd,ax,ay,az,fBalloon,fWing,fGravity',fBuoy];
    ...
    % Updating Values
    Plat=Plat+atand((otravel(2)-conds(11))/conds(12));  % deg, new latitude
    Plon=Plon+atand((newV(1)-conds(10))/conds(12));  % deg, new longitude
